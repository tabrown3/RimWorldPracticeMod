...
namespace ConfigurableGrowZone
{
    public class PowerStatTracker : MapComponent
    {
        ...
        public override void MapComponentTick()
        {
            ...
            //for (var i = 0; i < allNets.Count; i++)
            //{
            //    //var netCurrentEnergyGainRate = allNets[i].CurrentEnergyGainRate();
            //    var netCurrentStoredEnergy = allNets[i].CurrentStoredEnergy();
            //    var netStoredEnergyMax = allNets[i].batteryComps.Sum(u => u.Props.storedEnergyMax);
